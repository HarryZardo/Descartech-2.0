...
export default function Doacoes() {
  ...
  const handleOpenButtonClick = (userEmail: string) => {
    setContactEmail(userEmail);
    alert(`Entre em contato com ${userEmail}`);
  };
        ...
        <div className={styles.card_container}>
          <div className={styles.user_card}>
            ...
            <button
              ...
              onClick={() => handleOpenButtonClick("leandrosilva@gmail.com")}
            >
              Abrir
            </button>
          </div>
          ...
          <div className={styles.user_card}>
            ...
            <div className={styles.user_info}>
              <h2 className={styles.user_info__name}>
                Ana Mirellis Antônio
              </h2>
              <ul>
                <li>Monitor</li>
                <li>Estabilizador</li>
            ...
            <button
              className={styles.abrir_button}
              onClick={() => handleOpenButtonClick("anamirellis@gmail.com")}
            >
              Abrir
            </button>
          </div>
